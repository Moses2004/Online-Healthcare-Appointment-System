...
namespace Online_Healthcare_Appointment_System.Controllers
{
    public class PrescriptionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PrescriptionId,AppointmentId,DoctorNotes,PrescriptionDetails,DateIssued")] Prescription prescription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PrescriptionId,AppointmentId,DoctorNotes,PrescriptionDetails,DateIssued")] Prescription prescription)
        {
